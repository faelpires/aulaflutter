...
namespace DemoApi.Services
{
    public class ProductsService : IProductsService
    {
        ...
        public ProductsService(ICategoryService categoryService)
        {
            _productItems = new List<Product>()
            {
                ...
                new Product
                {
                    ...
                    Name = "Xbox Series X",
                    Brand = "Microsoft",
                    Url = "https://www.camparts.nl/web/image/109307/Xbox%20Series%20X%20Parts.jpg",
                    CategoryId = 2
                },
                new Product
                {
                    ...
                    Name = "Playstation 5",
                    Brand = "Sony",
                    Url = "https://www.camparts.nl/web/image/109309/Playstation%205%20Parts.jpg",
                    CategoryId = 2
                }
            };
        }
